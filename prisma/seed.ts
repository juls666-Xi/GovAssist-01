  ...
  const programs = await Promise.all([
    prisma.assistanceProgram.create({
      data: {
        ...
        category: "Health",
        requirementsText: "Valid ID, Medical Certificate, Proof of Income, Barangay Certificate of Residency",
    ...
    prisma.assistanceProgram.create({
      data: {
        ...
        category: "Education",
        requirementsText: "Valid ID, School Registration, Proof of Income, Barangay Certificate",
    ...
    prisma.assistanceProgram.create({
      data: {
        ...
        requirementsText: "Senior Citizen ID, Proof of Residency, Birth Certificate",
    ...
    prisma.assistanceProgram.create({
      data: {
        ...
        category: "Economic",
        requirementsText: "Valid ID, Business Plan, Barangay Certificate, Proof of Residency",
    ...
    prisma.assistanceProgram.create({
      data: {
        ...
        category: "Emergency",
        requirementsText: "Valid ID, Barangay Certificate, Damage Assessment Report",
